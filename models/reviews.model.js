...
exports.selectReviews = (
  ...
  let queryStr = `SELECT reviews.title, reviews.review_id, reviews.designer, reviews.review_img_url, reviews.votes, reviews.owner, reviews.review_created_at, COUNT (comment_id) AS comment_count
    FROM reviews
    LEFT JOIN comments
    ON reviews.review_id = comments.review_id`;
